...
router.post("/:room_id/message", isAuthenticated, upload.fields([{ name: 'file', maxCount: 1}]), messageRoomController.addMessage);
router.post("/:room_id/messages", isAuthenticated, messageRoomController.getMessages);
